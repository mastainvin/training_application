...
public class UserExerciseDataDaoImpl extends BasicRequestsDao implements UserExerciseDataDao {
	 ...
	 *
	 * @param userExercisesData the user exercises data
	 * @throws InsertDataBaseException the insert data base exception
	 */
	@Override
	public void addUserExerciseData(List<UserExerciseData> userExercisesData) throws InsertDataBaseException {
		List<Map<String, String>> valuesMapList = new ArrayList<>();
		for (UserExerciseData userExerciseData : userExercisesData) {
			ValuesMap valuesMap = new MapOfValuesInsert();
			Map<String, String> getMap = valuesMap.getMapOfValues(userExerciseData);
			valuesMapList.add(getMap);
		}

		this.addAll(valuesMapList);
	}

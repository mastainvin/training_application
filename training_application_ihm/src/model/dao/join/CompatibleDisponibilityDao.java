...
public interface CompatibleDisponibilityDao {
	 ...
	 *                                                  violation exception
	 */
	void addCompatibleDisponibility(Integer id_structure, Integer id_disponibility)
	 ...
	 *                                                  violation exception
	 */
	void deleteCompatibleDisponibility(Integer id_structure, Integer id_disponibility)
			throws EmptyResultsQueryException, SQLIntegrityConstraintViolationException;

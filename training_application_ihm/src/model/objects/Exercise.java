...
public class Exercise extends Observable {
	...
	public void copy(Exercise exercise) {
		...
		setBiomecanicFunctionList(exercise.getBiomecanicFunctionList());
		setIdExercise(exercise.getIdExercise());
		setMorphologiesList(exercise.getMorphologiesList());
		setName(exercise.getName());
		setUserExerciseDatas(exercise.getUserExerciseDatas());
		setChanged();
		notifyObservers();
	}

...
/**
 * The Class RepartitionConstantWeight.
 *
 * @author cytech
 */
public class RepartitionConstantWeight extends Repartition {

	/**
	 * Instantiates a new repartition constant weight.
	 *
	 * @param name the name
	 */
	public RepartitionConstantWeight(String name) {
		this.setName(name);
	}

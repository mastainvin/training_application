...
public interface BiomecanicFunctionUseLimbDao {
	 ...
	 */
	void addCompatibleBodyLimb(Integer id_biomecanicFunction, Integer id_bodyLimb) throws EmptyResultsQueryException, SQLIntegrityConstraintViolationException;
	 ...
	 * @throws SQLIntegrityConstraintViolationException the SQL integrity constraint violation exception
	 */
	void deleteCompatibleBodyLimb(Integer id_biomecanicFunction, Integer id_bodyLimb) throws EmptyResultsQueryException, SQLIntegrityConstraintViolationException;
}

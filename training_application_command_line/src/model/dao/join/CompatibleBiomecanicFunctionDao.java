...
public interface CompatibleBiomecanicFunctionDao {
	 ...
	 */
	void addCompatibleExercice(Integer id_biomecanicFunction, Integer id_exercice) throws EmptyResultsQueryException, SQLIntegrityConstraintViolationException;
	 ...
	 * @throws SQLIntegrityConstraintViolationException the SQL integrity constraint violation exception
	 */
	void deleteCompatibleExercice(Integer id_biomecanicFunction, Integer id_exercice) throws EmptyResultsQueryException, SQLIntegrityConstraintViolationException;
}
